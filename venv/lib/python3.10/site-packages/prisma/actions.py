...
class ServerActions:
    ...
    async def query_first(
        ...
        *args
        ...
        user = await Server.prisma().query_first(
            'SELECT * FROM Server WHERE ip_address = ?',
            'dhheabfhf',
        )
        ```
        """
    ...
    async def create(
        ...
        server = await Server.prisma().create(
            data={
                ...
                'ip_address': 'ggciceaie',
                'description': 'bbehjachib',
                'favicon': 'cadfabfehe',
                'versionId': 368800899,
                'maximumId': 1508029952,
            },
        )
        ```
        """
        ...
        *,
        ...
        total = await Server.prisma().create_many(
            data=[
                ...
                {
                    # data to create a Server record
                    'ip_address': 'fjfddhigg',
                    'description': 'hjaecfifb',
                    'favicon': 'cbbbjbfcii',
                    'versionId': 1149758321,
                    'maximumId': 1644289366,
                },
            ],
    ...
    async def find_many(
        ...
        # find the first 5 Server records ordered by the description field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Server record ordered by the favicon field
    ...
    async def group_by(
        ...
        *,
        ...
        -------
        ```py
        # group Server records by ip_address values
...
class PlayerActions:
    ...
    async def find_many(
        ...
        # find the first 5 Player records ordered by the username field
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Player record ordered by the authenticated field
...
class VersionActions:
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Version record ordered by the id field
...
class MaximumActions:
    __slots__ = (
        '_client',
        '_model',
    )

    def __init__(self, client: 'Client', model: Type['models.Maximum']) -> None:
        self._client = client
        self._model = model
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await Maximum.prisma().query_raw(
            'SELECT * FROM Maximum WHERE id = ?',
            60335757,
        )
        ```
        """
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await Maximum.prisma().query_first(
            'SELECT * FROM Maximum WHERE min = ?',
            'gieegcbeg',
        )
        ```
        """
    ...
    async def create(
        self,
        data: types.MaximumCreateInput,
        include: Optional[types.MaximumInclude] = None
    ) -> 'models.Maximum':
        """Create a new Maximum record.
        ...
        data
            Maximum record data
        include
            Specifies which relations should be loaded on the returned Maximum model

        Returns
        -------
        prisma.models.Maximum
            The created Maximum record
        ...
        -------
        ```py
        # create a Maximum record from just the required fields
        maximum = await Maximum.prisma().create(
            data={
                # data to create a Maximum record
                'min': 'bgcffadich',
                'max': 'fcbichhci',
            },
        )
    ...
    async def create_many(
        self,
        data: List[types.MaximumCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> int:
        """Create multiple Maximum records at once.
        ...
        -------
        ```py
        total = await Maximum.prisma().create_many(
            data=[
                {
                    # data to create a Maximum record
                    'min': 'bcggadccgf',
    ...
    async def delete(
        self,
        where: types.MaximumWhereUniqueInput,
        include: Optional[types.MaximumInclude] = None
    ) -> Optional['models.Maximum']:
        """Delete a single Maximum record.

        Parameters
        ----------
        where
            Maximum filter to select the record to be deleted, must be unique
        include
            Specifies which relations should be loaded on the returned Maximum model
        ...
        -------
        ```py
        maximum = await Maximum.prisma().delete(
            where={
                'id': 127474245,
            },
        )
    ...
    async def find_unique(
        ...
        """Find a unique Maximum record.

        Parameters
        ----------
        where
            Maximum filter to find the record, must be unique
        include
            Specifies which relations should be loaded on the returned Maximum model
        ...
        -------
        ```py
        maximum = await Maximum.prisma().find_unique(
            where={
                'id': 948921754,
            },
        )
    ...
    async def find_many(
        ...
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.MaximumWhereInput] = None,
        cursor: Optional[types.MaximumWhereUniqueInput] = None,
        include: Optional[types.MaximumInclude] = None,
        order: Optional[Union[types.MaximumOrderByInput, List[types.MaximumOrderByInput]]] = None,
    ) -> List['models.Maximum']:
        """Find multiple Maximum records.
        ...
        ----------
        take
            Limit the maximum number of Maximum records returned
        skip
            Ignore the first N results
        where
            Maximum filter to select records
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Maximum model
        order
            Order the returned Maximum records by any field

        Returns
        -------
        List[prisma.models.Maximum]
            The list of all Maximum records that could be found
        ...
        -------
        ```py
        # find the first 10 Maximum records
        maximums = await Maximum.prisma().find_many(take=10)

        # find the first 5 Maximum records ordered by the max field
        maximums = await Maximum.prisma().find_many(
            take=5,
            order={
                'max': 'desc',
            },
    ...
    async def find_first(
        ...
        skip
            Ignore the first N records
        where
            Maximum filter to select the record
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Maximum model
        ...
        -------
        prisma.models.Maximum
            The first Maximum record found, matching the given arguments
        None
            No record could be found
        ...
        -------
        ```py
        # find the second Maximum record ordered by the id field
        maximum = await Maximum.prisma().find_first(
            skip=1,
            order={
                'id': 'desc',
            },
    ...
    async def update(
        self,
        data: types.MaximumUpdateInput,
        where: types.MaximumWhereUniqueInput,
        include: Optional[types.MaximumInclude] = None
    ) -> Optional['models.Maximum']:
        """Update a single Maximum record.

        Parameters
        ----------
        data
            Maximum record data specifying what to update
        where
            Maximum filter to select the unique record to create / update
        include
            Specifies which relations should be loaded on the returned Maximum model
        ...
        -------
        ```py
        maximum = await Maximum.prisma().update(
            where={
                'id': 1964990155,
            },
            data={
                # data to update the Maximum record to
            },
        )
        ```
        """
    ...
    async def upsert(
        ...
        -------
        prisma.models.Maximum
            The created or updated Maximum record
        ...
        -------
        ```py
        maximum = await Maximum.prisma().upsert(
            where={
                'id': 1228891816,
            },
            data={
    ...
    async def update_many(
        self,
        data: types.MaximumUpdateManyMutationInput,
        where: types.MaximumWhereInput,
    ) -> int:
        """Update multiple Maximum records

        Parameters
        ----------
        data
            Maximum data to update the selected Maximum records to
        where
            Filter to select the Maximum records to update

        Returns
        -------
        int
            The total number of Maximum records that were updated
        ...
        -------
        ```py
        # update all Maximum records
        total = await Maximum.prisma().update_many(
            data={
                'min': 'cffcachfd'
            },
            where={}
    ...
    async def count(
        ...
        """Count the number of Maximum records present in the database

        Parameters
        ----------
        select
            Select the Maximum fields to be counted
        take
            Limit the maximum result
        skip
            Ignore the first N records
        where
            Maximum filter to find records
        cursor
            Specifies the position in the list to start counting results from, (typically an ID field)
        order
            This parameter is deprecated and will be removed in a future release
        ...
        prisma.types.MaximumCountAggregateOutput
            Data returned when `select` is used, the fields present in this dictionary will
            match the fields passed in the `select` argument
        ...
        ```py
        # total: int
        total = await Maximum.prisma().count()

        # results: prisma.types.MaximumCountAggregateOutput
        results = await Maximum.prisma().count(
            select={
                '_all': True,
                'max': True,
            },
    ...
    async def count(
        self,
        select: types.MaximumCountAggregateInput,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.MaximumWhereInput] = None,
        cursor: Optional[types.MaximumWhereUniqueInput] = None,
    ) -> types.MaximumCountAggregateOutput:
        ...

    async def count(
        self,
        select: Optional[types.MaximumCountAggregateInput] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.MaximumWhereInput] = None,
        cursor: Optional[types.MaximumWhereUniqueInput] = None,
    ) -> Union[int, types.MaximumCountAggregateOutput]:
        """Count the number of Maximum records present in the database
        ...
        if select is None:
            ...
            return cast(types.MaximumCountAggregateOutput, resp['data']['result']['_count'])

    async def delete_many(
        self,
        where: Optional[types.MaximumWhereInput] = None
    ) -> int:
        """Delete multiple Maximum records.

        Parameters
        ----------
        where
            Optional Maximum filter to find the records to be deleted

        Returns
        -------
        int
            The total number of Maximum records that were deleted
        ...
        -------
        ```py
        # delete all Maximum records
        total = await Maximum.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            operation='mutation',
    ...
    async def group_by(
        self,
        by: List['types.MaximumScalarFieldKeys'],
        *,
        where: Optional['types.MaximumWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        avg: Optional['types.MaximumAvgAggregateInput'] = None,
        sum: Optional['types.MaximumSumAggregateInput'] = None,
        min: Optional['types.MaximumMinAggregateInput'] = None,
        max: Optional['types.MaximumMaxAggregateInput'] = None,
        having: Optional['types.MaximumScalarWhereWithAggregatesInput'] = None,
        count: Optional[Union[bool, 'types.MaximumCountAggregateInput']] = None,
        order: Optional[Union[Mapping['types.MaximumScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.MaximumScalarFieldKeys', 'types.SortOrder']]]] = None,
    ) -> List['types.MaximumGroupByOutput']:
        """Group Maximum records by one or more field values and perform aggregations
        each group such as finding the average.

        Parameters
        ----------
        by
            List of scalar Maximum fields to group records by
        where
            Maximum filter to select records
        take
            Limit the maximum number of Maximum records returned
        ...
        Returns
        -------
        List[prisma.types.MaximumGroupByOutput]
            A list of dictionaries representing the Maximum record,
            this will also have additional fields present if aggregation arguments
            are used (see the above parameters)
        ...
        -------
        ```py
        # group Maximum records by min values
        # and count how many records are in each group
        results = await Maximum.prisma().group_by(
            ['min'],
            count=True,
        )
        ```
